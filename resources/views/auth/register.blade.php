<x-guest-layout>
    ...
    <div class="flex items-center mt-4 mb-2">
        <hr class="h-0 border-b border-solid border-grey-700 dark:border-gray-400 grow">
        <p class="mx-4 text-sm font-medium text-gray-700 uppercase dark:text-gray-300">{{ __('or') }}</p>
        <hr class="h-0 border-b border-solid border-grey-700 dark:border-gray-400 grow">
    </div>
